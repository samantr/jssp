...
/**
 * Simple command-line entry point for the first version.
 */
public final class JsspGaCli {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("JSSP GA - first minimal version");
        ...
        GeneticAlgorithm ga = new GeneticAlgorithm(instance, config);
        GeneticAlgorithmResult result = ga.run();
        long elapsedMillis = (System.nanoTime() - startedAt) / 1_000_000L;

        System.out.println();
        System.out.println("Best makespan : " + result.bestMakespan());
    ...
    private static void printUsage() {
        ...
        System.out.println("  --instance <path>        JSPLIB instance path. Default: bundled jsplib/ft06");
        System.out.println("  --population <int>       Default: 100");
        System.out.println("  --generations <int>      Default: 500");
        System.out.println("  --crossoverRate <double> Default: 0.9");
        System.out.println("  --mutationRate <double>  Default: 0.2");
        System.out.println("  --tournamentSize <int>   Default: 3");
        System.out.println("  --seed <long>            Default: 42");
        System.out.println("  --printSchedule <bool>   Default: false");
    }
}
