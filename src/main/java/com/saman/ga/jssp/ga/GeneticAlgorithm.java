...
public final class GeneticAlgorithm {
    ...
    public GeneticAlgorithm(JsspInstance instance, GeneticAlgorithmConfig config) {
        this(instance, config, List.of());
    }

    public GeneticAlgorithm(
            JsspInstance instance,
            GeneticAlgorithmConfig config,
            List<ConstraintFunction> dynamicConstraints
    ) {
        ...
        if (dynamicConstraints != null) {
            allConstraints.addAll(dynamicConstraints);
        }
     ...
     * It copies a random mask from parent A, then fills remaining positions
     * with parent B's jobs in order.
     */
    OperationBasedChromosome crossover(
            OperationBasedChromosome parentA,
            OperationBasedChromosome parentB
    ) {
